    ...
    >
      ...
      >
        ...
        >
          ...
          <button aria-label="Close cart" onClick={onClose} style={closeBtn}>
        ...
        {items.length === 0 ? (
          ...
          >
            <div style={{ width: 60, height: 60, borderRadius: "50%", background: "#F3ECDF", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 18, color: "#A15E38" }}>
            ...
            <button
              onClick={onClose}
              style={{ ...primaryBtn, width: "auto", padding: "13px 28px", marginTop: 22 }}
          ...
          <>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", gap: 10 }}>
                      ...
                      <button
                        ...
                        style={{ background: "none", border: "none", cursor: "pointer", color: "#B0A594", padding: 0, lineHeight: 0, flexShrink: 0 }}
                      >
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 12 }}>
                      <div style={{ display: "flex", alignItems: "center", border: "1px solid #D7CCBB", borderRadius: 999, overflow: "hidden" }}>
                        <button aria-label="Decrease quantity" onClick={() => setQty(item.slug, item.qty - 1)} style={stepBtn}>−</button>
                        <span style={{ minWidth: 28, textAlign: "center", fontWeight: 700, fontSize: 14 }}>{item.qty}</span>
                        <button aria-label="Increase quantity" onClick={() => setQty(item.slug, item.qty + 1)} style={stepBtn}>+</button>
                      </div>
            ...
            {/* footer */}
            <div style={{ borderTop: "1px solid #EAE0D0", padding: "22px 28px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 16 }}>
                <span style={{ fontSize: 14, color: "#6B6357", textTransform: "uppercase", letterSpacing: "0.08em", fontWeight: 700 }}>Subtotal</span>
                <span style={{ fontSize: 24, fontWeight: 700 }}>{formatINR(subtotal)}</span>
              </div>
              <button
              ...
              <div style={{ textAlign: "center", marginTop: 12, fontSize: 12, color: "#6B6357", display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
